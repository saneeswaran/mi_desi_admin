...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void register() async {
      final provider = Provider.of<StatemanagementProvider>(
        context,
        listen: false,
      );
      final authProvider = Provider.of<AuthProviders>(context, listen: false);
      final isSuccess = provider.loading;

      if (!isSuccess && formKey.currentState!.validate()) return;

      final bool isDone = await authProvider.registerUser(
        context: context,
