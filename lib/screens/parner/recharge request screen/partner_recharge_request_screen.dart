...
class PartnerRechargeRequestScreen extends StatefulWidget {
  const PartnerRechargeRequestScreen({super.key});

  @override
  State<PartnerRechargeRequestScreen> createState() =>
      _PartnerRechargeRequestScreenState();
}

class _PartnerRechargeRequestScreenState
    extends State<PartnerRechargeRequestScreen> {
